                ...
                <>
                  <div className="card routinesCard">
                    <div className="card-body">
                      <h5 className="card-title text-center">{routine.name}</h5>
                      <div className="card-text">
                          <div><b>Goal: </b> {routine.goal}</div>
                          <div><b>User:</b> {routine.creatorName}</div>
                      </div>
                      <div className="card-footer">
                      <div className="card-title text-center">Activities</div>
                      <div className="activitiesContainer">
                        {routine.activities.map((activity, index) => {
                          return (
                            <ul className=" list-group list-group-light list-group-small" key={index}>
